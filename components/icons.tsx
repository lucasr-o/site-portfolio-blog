// Inline SVG icons — no emoji, consistent 24x24 viewBox, currentColor.

export function Mark({ size = 26 }: { size?: number }) {
  // Custom glyph: a terminal prompt chevron + signal node inside a rounded frame.
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowUpRight({ className = "arrow" }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function MastodonIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function MailIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M4 7l8 5.5L20 7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
...
export function KeyIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <circle cx="8" cy="8" r="4.5" stroke="currentColor" strokeWidth="1.7" />
      <path d="M11 11l8 8M16 16l2-2M18 18l2-2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
